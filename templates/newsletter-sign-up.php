			...
			<div class="col-md-12">
				<div class="vertically--parent match-height text-center--sm">
					<div class="vertically--child text-center">
						<!-- <p class="text-yellow-light text-normal">Join our <span class="highlight">delicious newsletter</span></p> -->
						<p class="title-little">Our delicious newsletter</p>
						<p class="text-fancy text-super text-yellow-light">Good food and stories to your inbox</p>

						<div class="email-icon">
							<i class="fi-mail icon"></i>
						</div>
						...
						<form class="form-inline m-t-20" action="">
							...
							<button type="submit" class="btn btn-info btn-rounded btn-submit">Sign me up</button>
						</form>
					</div>
				</div>
			</div>
